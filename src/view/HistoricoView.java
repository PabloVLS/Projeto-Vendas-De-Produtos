...
public class HistoricoView extends javax.swing.JFrame {
    ...
    private int ultimoCodigoVenda = 0;
    ...
    private void initComponents() {
        ...
        jtHistorico.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jtHistorico.setForeground(new java.awt.Color(0, 0, 0));
        jtHistorico.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Codigo Venda", "IdProduto", "Nome Produto", "Quatidade Vendida", "Nome Cliente", "Data"
            }
        ) {
    ...
    public void atualizarTabelaHistorico(List<Historico> historico) {
        ...
        for (Historico historicoItem : historico) {
